    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       TextView num=(TextView)findViewById(R.id.numbers);
        ...
        family.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view){
                Intent  j = new Intent(MainActivity.this,Family_Members.class);
                startActivity(j);
            }
        });
        ...
        TextView openPhrases=(TextView)findViewById(R.id.phrases);
        openPhrases.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view){
